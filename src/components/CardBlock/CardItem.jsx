...
import {setAddItem} from '../../redux/slices/cardSlice'

function CardItem({id, title, imageUrl, price, types}) {
    const dispatch = useDispatch();
    const cardItem = useSelector((state) => state.cardReducer.itemsPizza)

    return (
        <>
            {
                cardItem.map((obj) => (
                    <div key={obj.id} {...obj} className="cart__item">
