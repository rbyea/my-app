...
import {setClearItem} from '../redux/slices/cardSlice'
import { useSelector, useDispatch } from 'react-redux';

function Card() {
  const dispatch = useDispatch();
  const items = useSelector((state) => state.cardReducer.itemsPizza)
      ...
      <div className="cart">
        <div className="cart__top">
          <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              Корзина</h2>
                            <div onClick={removeAllItem} className="cart__clear">
          ...
          <div className="cart__bottom-buttons">
            <Link to="/" className="button button--outline button--add go-back-btn">
              <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 13L1 6.93015L6.86175 1" stroke="#D3D3D3" strokedidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
